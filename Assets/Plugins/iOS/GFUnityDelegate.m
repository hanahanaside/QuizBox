...
// callback GF Popup start.
- (void)didShowGameFeatPopup {
    //NSLog(@"#didShowGameFeatPopup");
    const char* objName = [self.objectName UTF8String];
    UnitySendMessage(objName, "didShowGameFeatPopup", "");
}
- (void)didCloseGameFeatPopup {
    //NSLog(@"#didShowGameFeatPopup");
    const char* objName = [self.objectName UTF8String];
    UnitySendMessage(objName, "didCloseGameFeatPopup", "");
}
- (void)failGameFeatPopupData {
    //NSLog(@"#didShowGameFeatPopup");
    const char* objName = [self.objectName UTF8String];
    UnitySendMessage(objName, "failGameFeatPopupData", "");
}
